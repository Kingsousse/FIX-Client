...
public class AckCancellation extends AcknowledgmentMessage {

	private String clientOrderId;

	public AckCancellation() {
	}

	public AckCancellation(String clientOrderId) {
	...
	public MsgProtocoleType getProtocoleType() {
		return MsgProtocoleType.CANCEL_ORDER_ACK;
	}
}
